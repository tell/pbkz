...
In the generator folder, “tools.h” and “generate_random.cpp” are necessary.
...
In the generator folder, “ideal.h” and “generate_ideal.cpp” are necessary.

B3. Subroutines from NTL Library:
http://www.shoup.net/ntl/
“src/LLL_QP.c” and “src/LLL_RR.c” are necessary.
...
Please ignore them if the file “a.out” is output successfully. 
...
There are also some other options as “-genbasis”, “-lll”, ”-bkz”, “-enum”, “-genstrategy”, “-pfunc”,
”-randomizebasis”, “-withenum”, “-type (svp/ideal/unimodular)” and so on.
We will give some usages of these options in the examples below.
Also please reference “main.cpp” for more details.
...
The output file “str421approx” includes the BKZ blocksize strategy. 
...
You can check the BKZ reduced basis from “str100_1.05gh.bkz.log.**”,
get the details of ENUM search process from “str100_1.05gh.enum.log.**”
and ENUM search results from “svp100.log”.
...
is recoded from the open source code Sage-7.1, where the function is “random_unimodular_matrix()”.
